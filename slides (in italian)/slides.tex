...
\begin{frame}{Primo teorema di incompletezza di Gödel}
  ...
  \begin{block}{Teorema di incompletezza, Gödel (1931)}
    Se $T$ una teoria aritmetica coerente e ricorsivamente assiomatizzabile,
    con $\mathsf Q\subseteq T$ e $\NN\models T$, allora $T$ è incompleta.
  \end{block}
  ...
  \begin{tikzpicture}[
    ...
    \node[semanticroute,text width=32mm,minimum height=19mm,font=\bfseries]
      (satisfaction) at (35.5,11.5)
      {$\mathsf{Sat}$ non è definibile\\in $T$\\[.4mm]
       {\scriptsize\mdseries Lawvere in $\mathsf{Lind}_T$}};
    \node[semanticroute,text width=25mm,minimum height=19mm,font=\bfseries]
      (tarski) at (71.5,11.5)
      {$\mathsf{Truth}$ non è definibile in $T$\\[.4mm]
       {\scriptsize\mdseries Corollario immediato\\[-.2mm]}};
    \node[syntacticroute,text width=56mm,minimum height=19mm,font=\bfseries]
      ...
      {Lemma di diagonalizzazione di Gödel\\[.4mm]
       {\scriptsize\mdseries Adattando la dimostrazione di Lawvere in $\mathsf{Set}$}};
    \node[endpoint,text width=23mm,minimum height=19mm,font=\bfseries]
      (godel) at (103,0)
      {Gödel\\[.4mm]
       {\scriptsize\mdseries Incompletezza di $T$}};

    \draw[semanticflow] (lawvere.east) -- (satisfaction.west);
    \draw[semanticflow] (satisfaction.east) -- (tarski.west);
    \draw[semanticflow] (tarski.east) -- (godel.west);
    \draw[syntacticflow] (lawvere.east) -- (diagonal.west);
    \draw[syntacticflow] (diagonal.east) -- (godel.west);
  \end{tikzpicture}
\end{frame}
