...
\begin{remark}[Category generated by a deductive system]
    Given a deductive system $\mathcal D$ we can always construct a category $\mathcal C$ from it by taking the same objects and arrows of $\mathcal D$ and imposing the identity and associativity laws.
...
Now that we have the positive intuitionistic calculus generated by $\mathcal G$, we can define the cartesian closed category generated by it.