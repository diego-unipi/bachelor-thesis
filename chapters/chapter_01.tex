...
\begin{proof}
    ...
    \begin{align*}
        \ulcorner f \urcorner^\sharp &= \ev_{B,A} \langle (f \circ \pi_{1,A}')^* !_A, 1_A\rangle &&(\textnormal{by the definitions}) \\
                                     &= \ev_{B,A} \langle (f \circ \pi_{1,A}' (!_A \times 1_A))^*, 1_A\rangle &&(\textnormal{by distributivity of currying}) \\
                                     &= \ev_{B,A} \langle (f \circ \pi_{A,A}')^*, 1_A\rangle &&(\textnormal{by CC2b}) \\
                                     &=
    \end{align*}
\end{proof}
...
Now that we have defined the structure of a cartesian closed category, we want to define a new category that is built from an existing one,
