...
\begin{proof}
    ...
    \begin{itemize}
        \item[$\boxed{\begin{array}{c}\textnormal{well-}\\\textnormal{definedness}\end{array}}$] As usual, we define the equivalence relation on the arrows of $\mathcal C\langle x\rangle$
        \[ \varphi(x) \sim_{\kappa} \psi(x) \overset{\textnormal{def}}{\iff} \kappa_{x \in A}\varphi(x) = \kappa_{x \in A}\psi(x), \]
        and we check that it respects all the properties listed in the definition of $\underset{x}{=}$.
        ...
        \begin{itemize}
            ...
            \begin{align*}
                \kappa_{x \in A}(\psi(x)^*) \circ \langle x \circ !_B, 1_B\rangle &\underset{x}{=} (\kappa_{x \in A}\psi(x) \circ \alpha_{A,B,E})^* \circ \langle x \circ !_B, 1_B\rangle \\
                                                                                  ...
                                                                                  &\underset{x}{=} (\kappa_{x \in A}\psi(x) \circ (\langle x \circ !_B, 1_B\rangle \times 1_E) \circ \alpha_{A,B,E})^* &&(\textnormal{by $\heartsuit$})\\
                                                                                  &\underset{x}{=} (\psi(x) \circ \alpha_{A,B,E})^* \\
                                                                                  &\underset{x}{=} (\psi(x))^*.
            \end{align*}
            where $\clubsuit$ is the identity $f^* \circ g = (f \circ (g \times 1_E))^*$, for every $f : B \times E \to D$ and $g : A \to B$, $\heartsuit$ is the identity $\alpha_{A,B,E} \circ (g \times 1_E) = (g \times 1_E) \circ \alpha_{A,B,E}$, for every $g : A \to B$,
            and the fourth equality is by the inductive hypothesis.
        \end{itemize}
        ...
        \begin{align*}
            \kappa_{x \in A}(\varphi(x)) &\underset{x}{=} \kappa_{x \in A}(f \circ \langle x \circ !_B, 1_B\rangle) \\
                                         &\underset{x}{=} \kappa_{x \in A}(f) \circ \langle \pi_{A,B}, \kappa_{x \in A}(\langle x \circ !_B, 1_B\rangle)\rangle \\
                                         &\underset{x}{=} (f \circ \pi_{A,A \times B}') \circ \langle \pi_{A,B}, \langle \pi_{A,1} \circ \langle \pi_{A,B}, !_B \circ \pi_{A,B}'\rangle, \pi_{A,B}' \rangle \rangle \\
                                         &\underset{x}{=} (f \circ \pi_{A,A \times B}') \circ \langle \pi_{A,B}, \langle \pi_{A,B}, \pi_{A,B}' \rangle \rangle \\
                                         &\underset{x}{=} f \circ (\pi_{A,A \times B}' \circ \langle \pi_{A,B}, \langle \pi_{A,B}, \pi_{A,B}' \rangle \rangle) \\
                                         &\underset{x}{=} f \circ \langle \pi_{A,B}, \pi_{A,B}' \rangle \underset{x}{=} f,
        \end{align*}
