...
\begin{example}
    ...
    \[ \frac{\top \xrightarrow{g} B \Leftarrow A}{A \xrightarrow{g^\natural} B} \]
    as $g^\natural := \ev_{B,A} \circ \langle g\circ !_A,1_A\rangle$. 
\end{example}
...
\begin{example}[Co-pairing arrow]
    ...
    as $[f,g] := (\zeta_{A,B}^C \circ \langle \ulcorner f \urcorner, \ulcorner g \urcorner\rangle)^\natural$.
