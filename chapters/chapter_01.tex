...
\begin{proof}
    ...
    since $\langle x \circ !_1, 1_1\rangle \underset{x}{=} \langle 1_A, !_A \rangle \circ x$, we can define $f := \kappa_{x \in A} \varphi(x) \circ \langle 1_A, !_A \rangle : A \to C$, and we have:
    \[ f \circ x \underset{x}{=} \varphi(x). \]
