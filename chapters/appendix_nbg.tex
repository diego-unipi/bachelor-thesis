...
The list of axioms roughly follows the exposition given in \cite{Schindler2014}.
...
\begin{theorem}[Conservativity of $\mathsf{NBG}$ over $\mathsf{ZFC}$]\label{thm:nbg-conservativity}
    ...
    \[\mathsf{NBG}+\mathsf{GC}\vdash\varphi \Longleftrightarrow \mathsf{ZFC}\vdash\varphi.\]
    In other words, every theorem about sets which can be proved using classes can already be proved in $\mathsf{ZFC}$.
\end{theorem}

See \cite{Felgner1971} for a proof of this theorem.
